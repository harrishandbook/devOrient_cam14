    ...
    axisInput.addEventListener("change", function(e) {
        ...
        window.addEventListener("devicemotion", function(event) {
          ...
          grid.style.transform = 
              "rotate(" + ( calcAngle(event.accelerationIncludingGravity.x,event.accelerationIncludingGravity.y)-90 ) + "deg) ";
            
          axis.style.transform = 
              "rotate(" + ( -ax + dcalcAngle(event.accelerationIncludingGravity.x,event.accelerationIncludingGravity.y)-90 ) + "deg) ";
        });
